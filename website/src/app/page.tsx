...
export default function Home() {
  ...
  const macCommand = 'curl -fsSL https://raw.githubusercontent.com/ekansh-arora0/payguard-public/main/install_simple.sh | bash'
  const winCommand = 'pip install pystray Pillow mss pyperclip && curl -fsSL https://raw.githubusercontent.com/ekansh-arora0/payguard-public/main/payguard_crossplatform.py -o payguard.py && python payguard.py'
  const linuxCommand = 'curl -fsSL https://raw.githubusercontent.com/ekansh-arora0/payguard-public/main/install_simple.sh | bash'
